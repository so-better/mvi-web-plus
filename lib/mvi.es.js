...
class Spy {
  ...
  scrollHandle() {
    let overflowX = obj.element.getCssStyle(this.$root, "overflow-x");
    let overflowY = obj.element.getCssStyle(this.$root, "overflow-y");
...
const cell_vue_vue_type_style_index_0_scoped_1bfaf41d_lang = "";
const _sfc_main$15 = {
  name: "m-cell",
  props: {
    icon: {
...
const Cell = /* @__PURE__ */ _export_sfc(_sfc_main$15, [["render", _sfc_render$15], ["__scopeId", "data-v-1bfaf41d"]]);
Cell.install = (app) => {
...
const image_vue_vue_type_style_index_0_scoped_9dc7c92c_lang = "";
const _sfc_main$$ = {
  name: "m-image",
  data() {
    return {
...
const Image = /* @__PURE__ */ _export_sfc(_sfc_main$$, [["render", _sfc_render$$], ["__scopeId", "data-v-9dc7c92c"]]);
Image.install = (app) => {
...
const popup_vue_vue_type_style_index_0_scoped_224771cc_lang = "";
const _sfc_main$Z = {
  name: "m-popup",
  data() {
    return {
...
const Popup = /* @__PURE__ */ _export_sfc(_sfc_main$Z, [["render", _sfc_render$Z], ["__scopeId", "data-v-224771cc"]]);
Popup.install = (app) => {
...
const dialogPc_vue_vue_type_style_index_0_scoped_51af1de0_lang = "";
const _sfc_main$P = {
  name: "m-dialog-pc",
  data() {
    return {
...
const dialogPcComponent = /* @__PURE__ */ _export_sfc(_sfc_main$P, [["render", _sfc_render$P], ["__scopeId", "data-v-51af1de0"]]);
const Dialog = {
...
const progress_vue_vue_type_style_index_0_scoped_d4c4247c_lang = "";
const _sfc_main$K = {
  name: "m-progress",
  props: {
    value: {
...
const Progress = /* @__PURE__ */ _export_sfc(_sfc_main$K, [["render", _sfc_render$K], ["__scopeId", "data-v-d4c4247c"]]);
...
const circleProgress_vue_vue_type_style_index_0_scoped_04cf2aff_lang = "";
const _sfc_main$B = {
...
const CircleProgress = /* @__PURE__ */ _export_sfc(_sfc_main$B, [["render", _sfc_render$B], ["__scopeId", "data-v-04cf2aff"]]);
...
const tabs_vue_vue_type_style_index_0_scoped_8f293f7d_lang = "";
const _sfc_main$q = {
  name: "m-tabs",
  data() {
    return {
...
const Tabs = /* @__PURE__ */ _export_sfc(_sfc_main$q, [["render", _sfc_render$q], ["__scopeId", "data-v-8f293f7d"]]);
Tabs.install = (app) => {
...
const table_vue_vue_type_style_index_0_scoped_0ff827b9_lang = "";
const _sfc_main$l = {
  name: "m-table",
  ...
  data() {
    return {
      ...
      dragConfig: {
        ...
        startX: 0,
        columnWidth: {},
        minWidth: obj.element.rem2px(0.8)
      }
    };
  },
  computed: {
    ...
    bodyColumnStyle() {
      return (index) => {
        this.columnAlignKey;
        return {
          width: this.headerColumnRefs[index] ? obj.element.getCssStyle(this.headerColumnRefs[index], "width") : "0px"
        };
      };
    },
    sortIconStyle() {
  ...
  mounted() {
    ...
    obj.event.on(document.documentElement, `mousemove.table_${this.uid}`, (e) => {
      if (this.dragConfig.column) {
        const moveX = e.pageX - this.dragConfig.startX;
        const minWidth = parseFloat(obj.element.getCssStyle(this.headerColumnRefs[this.dragConfig.index], "min-width")) || this.dragConfig.minWidth;
        const maxWidth = parseFloat(obj.element.getCssStyle(this.$refs.headerRow, "width")) - this.getColumnTotalMinWidth(this.dragConfig.column);
        let width = parseFloat(obj.element.getCssStyle(this.headerColumnRefs[this.dragConfig.index], "width"));
        width += moveX;
    ...
    obj.event.on(document.documentElement, `mouseup.table_${this.uid}`, (e) => {
      if (this.dragConfig.column) {
  ...
  methods: {
    getColumnTotalMinWidth(currentColumn) {
      ...
      this.columnData.forEach((column, index) => {
        ...
        if (column.width && column.width != "auto" || this.dragConfig.columnWidth[column.prop]) {
          total += parseFloat(obj.element.getCssStyle(this.headerColumnRefs[index], "width"));
        } else {
    ...
    resizeColumnWidth(event2, column, index) {
      this.dragConfig.startX = event2.pageX;
      this.dragConfig.column = column;
      this.dragConfig.index = index;
      this.$emit("drag-start", column, index, event2);
    },
  ...
  beforeUnmount() {
    ...
    obj.event.off(document.documentElement, `mousemove.table_${this.uid} mouseup.table_${this.uid}`);
  }
};
...
const _hoisted_5$9 = ["onMousedown"];
const _hoisted_6$8 = {
  key: 0,
...
function _sfc_render$l(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", {
        ...
        createElementVNode("tr", _hoisted_3$c, [
          (openBlock(true), createElementBlock(Fragment, null, renderList($data.columnData, (column, index) => {
            return openBlock(), createElementBlock("th", {
              ...
              index < $data.columnData.length - 1 && $props.draggable ? (openBlock(), createElementBlock("div", {
                key: 0,
                onMousedown: ($event) => $options.resizeColumnWidth($event, column, index),
                class: "m-table-drag"
    ...
    createElementVNode("div", {
      ...
      $props.loading ? (openBlock(), createElementBlock("div", _hoisted_6$8, [
        createVNode(_component_Loading, {
          color: "#bbb",
          size: "0.3rem"
        }),
        ...
        $data.rowData.length ? (openBlock(), createElementBlock("table", _hoisted_7$7, [
            ...
            return openBlock(), createElementBlock("tr", {
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList($data.columnData, (column, columnIndex) => {
                return openBlock(), createElementBlock("td", {
                  ...
                  style: normalizeStyle($options.bodyColumnStyle(columnIndex))
                }, [
                  createVNode(_component_Tooltip, {
                    disabled: !column.ellipsis,
                    block: "",
                    title: $options.dataFormat(row, column),
                    trigger: "hover"
                  }, {
                    default: withCtx(() => [
                      createElementVNode("div", {
                        ...
                        column.type == "selection" ? (openBlock(), createBlock(_component_Checkbox, {
                          ...
                          column.type == "custom" && _ctx.$slots.custom ? renderSlot(_ctx.$slots, "custom", {
                            ...
                            column,
                            columnIndex
                          }, void 0, true) : (openBlock(), createElementBlock("span", _hoisted_8$6, toDisplayString($options.dataFormat(row, column)), 1))
                        ], 2))
                      ], 2)
                    ]),
                    _: 2
        ...
        ])) : (openBlock(), createElementBlock("div", _hoisted_9$4, toDisplayString($props.noDataMsg), 1))
      ], 64))
    ], 6)
  ], 2);
}
const Table = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["render", _sfc_render$l], ["__scopeId", "data-v-0ff827b9"]]);
Table.install = (app) => {
  app.component(Table.name, Table);
};
const calendar_vue_vue_type_style_index_0_scoped_93022d3b_lang = "";
const _sfc_main$k = {
  name: "m-calendar",
...
const _hoisted_10$3 = { class: "mvi-calendar-date-header-item" };
    ...
    $props.view == "year" ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(new Array(3), (item, index) => {
      ...
      createElementVNode("div", _hoisted_9$3, [
        (openBlock(true), createElementBlock(Fragment, null, renderList($props.weekText, (item) => {
          return openBlock(), createElementBlock("div", _hoisted_10$3, toDisplayString(item), 1);
        }), 256))
      ]),
...
const Calendar = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["render", _sfc_render$k], ["__scopeId", "data-v-93022d3b"]]);
...
const imagePreview_vue_vue_type_style_index_0_scoped_8c3f058a_lang = "";
const _sfc_main$h = {
...
const _withScopeId$1 = (n) => (pushScopeId("data-v-8c3f058a"), n = n(), popScopeId(), n);
const _hoisted_1$a = {
  key: 0,
...
const ImagePreview = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["render", _sfc_render$h], ["__scopeId", "data-v-8c3f058a"]]);
...
const select_vue_vue_type_style_index_0_scoped_94232362_lang = "";
const _sfc_main$b = {
  name: "m-select",
...
const Select = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["render", _sfc_render$b], ["__scopeId", "data-v-94232362"]]);
Select.install = (app) => {
  app.component(Select.name, Select);
};
const autocomplete_vue_vue_type_style_index_0_scoped_e97bc7f4_lang = "";
const _sfc_main$a = {
  name: "m-autocomplete",
  data() {
    return {
    ...
    createVNode(_component_Layer, {
      ...
      default: withCtx(() => [
        createElementVNode("div", {
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList($options.computedFilter, (item) => {
            return openBlock(), createElementBlock("div", {
...
const Autocomplete = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["render", _sfc_render$a], ["__scopeId", "data-v-e97bc7f4"]]);
Autocomplete.install = (app) => {
  app.component(Autocomplete.name, Autocomplete);
};
const dateChooser_vue_vue_type_style_index_0_scoped_fb236e1d_lang = "";
const _sfc_main$9 = {
  name: "m-date-chooser",
  data() {
    return {
...
const _withScopeId = (n) => (pushScopeId("data-v-fb236e1d"), n = n(), popScopeId(), n);
...
const _hoisted_9$1 = { class: "mvi-date-chooser-date-left" };
const _hoisted_10$1 = { class: "mvi-date-chooser-date-center" };
      ...
      default: withCtx(() => [
        createElementVNode("div", _hoisted_3$3, [
          ...
          createVNode(_component_Calendar, {
            ...
            ref: "calendar"
          }, null, 8, ["view", "modelValue", "month-text", "week-text", "start-date", "end-year", "active", "type", "onDateClick", "onMonthClick", "onYearClick"])
        ], 512)
      ]),
      _: 1
...
const DateChooser = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$9], ["__scopeId", "data-v-fb236e1d"]]);
...
const editor_vue_vue_type_style_index_0_scoped_40ea2c71_lang = "";
const _sfc_main$7 = {
  name: "m-editor",
  ...
  methods: {
    ...
    autoLayerOffset(refName) {
      const b1 = obj.element.getElementBounding(this.$el);
      const b2 = obj.element.getElementBounding(this.$refs[refName].$el);
    ...
    onScroll() {
      const setScroll = (el) => {
        obj.event.on(el, `scroll.editor_${this.uid}`, (e) => {
    ...
    removeScroll() {
      const removeScroll = (el) => {
        obj.event.off(el, `scroll.editor_${this.uid}`);
        if (el.parentNode) {
    ...
    handlePasteHtml(data2, elements) {
      AlexElement$1.flatElements(elements).forEach((el) => {
    ...
    setTabelColumnResize(table, firstRow, column, i) {
      ...
      obj.event.off(column._elm, "mousedown");
      obj.event.off(document.documentElement, `mousemove.editor_table_${table.key}_${index}_${this.uid} mouseup.editor_table_${table.key}_${index}_${this.uid}`);
      let canResize = false;
      let start = 0;
      obj.event.on(column._elm, "mousedown", (e) => {
        if (this.disabled) {
          return;
        }
        const rect = obj.element.getElementBounding(column._elm);
        if (Math.abs(rect.left + column._elm.offsetWidth - e.pageX) < obj.element.rem2px(0.2)) {
          canResize = true;
          start = e.pageX;
        } else {
          canResize = false;
      ...
      obj.event.on(document.documentElement, `mousemove.editor_table_${table.key}_${index}_${this.uid}`, (e) => {
        if (this.disabled) {
          return;
        }
        if (canResize) {
      ...
      obj.event.on(document.documentElement, `mouseup.editor_table_${table.key}_${index}_${this.uid}`, (e) => {
        if (this.disabled) {
          return;
        }
        if (canResize) {
  ...
  beforeUnmount() {
    this.removeScroll();
    const data2 = obj.event.get(document.documentElement);
    for (let key in data2) {
      if (key.startsWith("mousemove.editor_") || key.startsWith("mouseup.editor_")) {
        obj.event.off(document.documentElement, key);
      }
    }
  }
};
...
function _sfc_render$7(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$2, [
    ...
    createVNode(_component_m_layer, {
      ...
      closable: "",
      ref: "linkLayer",
      onShowing: _cache[10] || (_cache[10] = ($event) => $options.autoLayerOffset("linkLayer"))
    }, {
      default: withCtx(() => [
    ...
    createVNode(_component_m_layer, {
      ...
      "onUpdate:modelValue": _cache[15] || (_cache[15] = ($event) => $data.mediaAdjusterProps.show = $event),
      fixed: "",
      ...
      closable: "",
      ref: "mediaLayer",
      onShowing: _cache[16] || (_cache[16] = ($event) => $options.autoLayerOffset("mediaLayer"))
    }, {
      default: withCtx(() => [
        createElementVNode("div", _hoisted_7$1, [
          createElementVNode("div", {
            onClick: _cache[11] || (_cache[11] = ($event) => $options.setMediaWidth("20%")),
            class: "mvi-editor-layer-item"
          }, "20%"),
          createElementVNode("div", {
            onClick: _cache[12] || (_cache[12] = ($event) => $options.setMediaWidth("50%")),
            class: "mvi-editor-layer-item"
          }, "50%"),
          createElementVNode("div", {
            onClick: _cache[13] || (_cache[13] = ($event) => $options.setMediaWidth("100%")),
            class: "mvi-editor-layer-item"
          }, "100%"),
          createElementVNode("div", {
            onClick: _cache[14] || (_cache[14] = (...args) => $options.deleteMedia && $options.deleteMedia(...args)),
            class: "mvi-editor-layer-item"
          }, [
    ...
    createVNode(_component_m_layer, {
      ...
      "onUpdate:modelValue": _cache[24] || (_cache[24] = ($event) => $data.tableAdjusterProps.show = $event),
      fixed: "",
      ...
      closable: "",
      ref: "tableLayer",
      onShowing: _cache[25] || (_cache[25] = ($event) => $options.autoLayerOffset("tableLayer"))
    }, {
      default: withCtx(() => [
        createElementVNode("div", _hoisted_8$1, [
          createElementVNode("div", {
            onClick: _cache[17] || (_cache[17] = ($event) => $options.insertParagraph("up")),
            class: "mvi-editor-layer-item"
          }, [
            createVNode(_component_Icon, {
          ...
          createElementVNode("div", {
            onClick: _cache[18] || (_cache[18] = ($event) => $options.insertParagraph("down")),
            class: "mvi-editor-layer-item"
          }, [
            createVNode(_component_Icon, { type: "turn-arrow-text" })
          ]),
          createElementVNode("div", {
            onClick: _cache[19] || (_cache[19] = (...args) => $options.addTableRow && $options.addTableRow(...args)),
            style: normalizeStyle({ color: $props.activeColor }),
            class: "mvi-editor-layer-item"
          }, toDisplayString($data.tableAdjusterProps.props.insertRowText), 5),
          createElementVNode("div", {
            onClick: _cache[20] || (_cache[20] = (...args) => $options.removeTableRow && $options.removeTableRow(...args)),
            class: "mvi-editor-layer-item"
          }, toDisplayString($data.tableAdjusterProps.props.removeRowText), 1),
          createElementVNode("div", {
            onClick: _cache[21] || (_cache[21] = (...args) => $options.addTableColumn && $options.addTableColumn(...args)),
            style: normalizeStyle({ color: $props.activeColor }),
            class: "mvi-editor-layer-item"
          }, toDisplayString($data.tableAdjusterProps.props.insertColumnText), 5),
          createElementVNode("div", {
            onClick: _cache[22] || (_cache[22] = (...args) => $options.removeTableColumn && $options.removeTableColumn(...args)),
            class: "mvi-editor-layer-item"
          }, toDisplayString($data.tableAdjusterProps.props.removeColumnText), 1),
          createElementVNode("div", {
            onClick: _cache[23] || (_cache[23] = (...args) => $options.deleteTable && $options.deleteTable(...args)),
            class: "mvi-editor-layer-item"
          }, [
            createVNode(_component_Icon, { type: "trash-alt" })
          ])
...
const Editor = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$7], ["__scopeId", "data-v-40ea2c71"]]);
Editor.install = (app) => {
...
const _sfc_main$6 = {
  ...
  mounted() {
    obj.event.on(document.documentElement, `mousedown.editor_menus_${this.uid}`, (e) => {
      if (!this.instance) {
        return;
      }
      if (!obj.element.isContains(this.$el, e.target) && !obj.element.isContains(this.instance.$el, e.target)) {
  ...
  beforeUnmount() {
    obj.event.off(document.documentElement, `click.editor_menus_${this.uid}`);
  }
};
...
const editorMenu_vue_vue_type_style_index_0_scoped_2f4bd2a0_lang = "";
const getMenu = (name) => {
  if (name == "custom") {
    return null;
  }
      ...
      if (Array.isArray(this.list)) {
        return this.list.map((item) => {
          ...
          if (obj.common.isObject(item)) {
            obj$1.label = item.label;
            obj$1.value = item.value;
            obj$1.icon = this.parseIcon(item.icon);
          } else if (typeof item == "string") {
            obj$1.label = item;
            obj$1.value = item;
            obj$1.icon = this.parseIcon(null);
          }
          return obj$1;
        });
      }
      ...
      return {
        ...
        select: (files) => {
          if (this.menus.useBase64) {
            files.forEach((file2) => {
              obj.file.dataFileToBase64(file2).then((base64) => {
                if (this.name == "image") {
...
const EditorMenu = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$4], ["__scopeId", "data-v-2f4bd2a0"]]);
