...
const editor_vue_vue_type_style_index_0_scoped_6b99c9cc_lang = "";
const _sfc_main$7 = {
  name: "m-editor",
...
const _hoisted_3$1 = ["data-placeholder"];
...
const Editor = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$7], ["__scopeId", "data-v-6b99c9cc"]]);
Editor.install = (app) => {
...
const editorMenu_vue_vue_type_style_index_0_scoped_6626368e_lang = "";
const getMenu = (name) => {
  if (name == "custom") {
    return null;
  }
  ...
  return openBlock(), createElementBlock("div", {
    ...
    $props.type == "select" || $props.type == "display" ? (openBlock(), createBlock(_component_Layer, {
      ...
      default: withCtx(() => [
        ...
        _ctx.$slots.layer ? renderSlot(_ctx.$slots, "layer", { key: 5 }, void 0, true) : createCommentVNode("", true)
      ]),
      _: 3
...
const EditorMenu = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$4], ["__scopeId", "data-v-6626368e"]]);
...
export {
  ...
  definedMenus as definedEditorMenus,
  install,
  version
};
