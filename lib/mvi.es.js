...
const table_vue_vue_type_style_index_0_scoped_e6b5b815_lang = "";
const _sfc_main$l = {
  name: "m-table",
        ...
        createElementVNode("tr", _hoisted_3$c, [
          (openBlock(true), createElementBlock(Fragment, null, renderList($data.columnData, (column, index) => {
            return openBlock(), createElementBlock("th", {
              ...
              index < $data.columnData.length - 1 ? (openBlock(), createElementBlock("div", {
                key: 0,
...
const Table = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["render", _sfc_render$l], ["__scopeId", "data-v-e6b5b815"]]);
Table.install = (app) => {
