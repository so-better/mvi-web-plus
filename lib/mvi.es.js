...
const table_vue_vue_type_style_index_0_scoped_26f599e3_lang = "";
const _sfc_main$l = {
  name: "m-table",
...
const Table = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["render", _sfc_render$l], ["__scopeId", "data-v-26f599e3"]]);
Table.install = (app) => {
...
const select_vue_vue_type_style_index_0_scoped_b3f0d00d_lang = "";
const _sfc_main$b = {
  name: "m-select",
  ...
  computed: {
    ...
    selectLabel() {
      if (this.multiple) {
        ...
        this.options.forEach((item, index) => {
          if (Array.isArray(this.modelValue)) {
            let flag = this.modelValue.some((i) => {
              return obj.common.equal(i, item[this.props.value]);
            });
            if (flag) {
        ...
        let label = "";
        this.options.forEach((item, index) => {
          if (obj.common.equal(this.modelValue, item[this.props.value])) {
    ...
    optionClick(item) {
      ...
      if (this.multiple) {
        ...
        let flag = arr.some((tmp) => {
          return obj.common.equal(tmp, item[this.props.value]);
        });
        if (flag) {
          arr = arr.filter((tmp) => {
            return !obj.common.equal(tmp, item[this.props.value]);
        ...
        this.$emit(
          ...
          this.options.filter((tmp) => {
            return arr.some((tmp2) => {
              return obj.common.equal(tmp[this.props.value], tmp2);
            });
          })
        );
      } else {
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList($props.options, (item) => {
            return openBlock(), createElementBlock("div", {
              ...
              createElementVNode("div", {
                ...
                innerHTML: item[$props.props.label]
              }, null, 8, _hoisted_5$3),
...
const Select = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["render", _sfc_render$b], ["__scopeId", "data-v-b3f0d00d"]]);
Select.install = (app) => {
