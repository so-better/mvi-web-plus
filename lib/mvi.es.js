...
const loading_vue_vue_type_style_index_0_scoped_10f85928_lang = "";
const _sfc_main$S = {
  name: "m-loading",
  props: {
    //类型
...
const _withScopeId$4 = (n) => (pushScopeId("data-v-10f85928"), n = n(), popScopeId(), n);
const _hoisted_1$F = { class: "mvi-loading" };
const _hoisted_2$z = ["width", "height", "stroke"];
const _hoisted_3$s = /* @__PURE__ */ createStaticVNode('<g fill="none" fill-rule="evenodd" data-v-10f85928><g transform="translate(1 1)" stroke-width="2" data-v-10f85928><circle stroke-opacity=".2" cx="18" cy="18" r="18" data-v-10f85928></circle><path d="M36 18c0-9.94-8.06-18-18-18" data-v-10f85928><animateTransform attributeName="transform" type="rotate" from="0 18 18" to="360 18 18" dur="1s" repeatCount="indefinite" data-v-10f85928></animateTransform></path></g></g>', 1);
const _hoisted_4$m = [
  _hoisted_3$s
];
const _hoisted_5$f = ["width", "height", "fill"];
const _hoisted_6$b = /* @__PURE__ */ createStaticVNode('<circle cx="30" cy="30" r="30" data-v-10f85928><animate attributeName="r" from="30" to="30" begin="0s" dur="0.8s" values="30;18;30" calcMode="linear" repeatCount="indefinite" data-v-10f85928></animate><animate attributeName="fill-opacity" from="1" to="1" begin="0s" dur="0.8s" values="1;.5;1" calcMode="linear" repeatCount="indefinite" data-v-10f85928></animate></circle><circle cx="120" cy="30" r="18" fill-opacity="0.3" data-v-10f85928><animate attributeName="r" from="18" to="18" begin="0s" dur="0.8s" values="18;30;18" calcMode="linear" repeatCount="indefinite" data-v-10f85928></animate><animate attributeName="fill-opacity" from="0.5" to="0.5" begin="0s" dur="0.8s6s" values=".5;1;.5" calcMode="linear" repeatCount="indefinite" data-v-10f85928></animate></circle><circle cx="210" cy="30" r="30" data-v-10f85928><animate attributeName="r" from="30" to="30" begin="0s" dur="0.8s" values="30;18;30" calcMode="linear" repeatCount="indefinite" data-v-10f85928></animate><animate attributeName="fill-opacity" from="1" to="1" begin="0s" dur="0.8s" values="1;.5;1" calcMode="linear" repeatCount="indefinite" data-v-10f85928></animate></circle>', 3);
const _hoisted_9$4 = [
  _hoisted_6$b
];
...
const Loading = /* @__PURE__ */ _export_sfc(_sfc_main$S, [["render", _sfc_render$S], ["__scopeId", "data-v-10f85928"]]);
Loading.install = (app) => {
