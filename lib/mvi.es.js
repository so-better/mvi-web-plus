...
const table_vue_vue_type_style_index_0_scoped_c0c36e59_lang = "";
const _sfc_main$l = {
  name: "m-table",
  ...
  data() {
    return {
      ...
      dragConfig: {
        ...
        startX: 0,
        columnWidth: {},
        minWidth: obj$1.element.rem2px(0.8)
      }
    };
  },
  computed: {
  ...
  mounted() {
    ...
    obj$1.event.on(document.documentElement, `mousemove.table_${this.uid}`, (e) => {
      if (this.dragConfig.column) {
        const moveX = e.pageX - this.dragConfig.startX;
        const minWidth = parseFloat(obj$1.element.getCssStyle(this.headerColumnRefs[this.dragConfig.index], "min-width")) || this.dragConfig.minWidth;
        const maxWidth = parseFloat(obj$1.element.getCssStyle(this.$refs.headerRow, "width")) - this.getColumnTotalMinWidth(this.dragConfig.column);
        let width = parseFloat(obj$1.element.getCssStyle(this.headerColumnRefs[this.dragConfig.index], "width"));
        width += moveX;
    ...
    obj$1.event.on(document.documentElement, `mouseup.table_${this.uid}`, (e) => {
      if (this.dragConfig.column) {
    ...
    getColumnTotalMinWidth(currentColumn) {
      ...
      this.columnData.forEach((column, index) => {
        ...
        if (column.width && column.width != "auto" || this.dragConfig.columnWidth[column.prop]) {
          total += parseFloat(obj$1.element.getCssStyle(this.headerColumnRefs[index], "width"));
        } else {
  ...
  beforeUnmount() {
    ...
    obj$1.event.off(document.documentElement, `mousemove.table_${this.uid} mouseup.table_${this.uid}`);
  }
};
...
function _sfc_render$l(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", {
    ...
    createTextVNode(toDisplayString($data.dragConfig.columnWidth) + " ", 1),
...
const Table = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["render", _sfc_render$l], ["__scopeId", "data-v-c0c36e59"]]);
Table.install = (app) => {
