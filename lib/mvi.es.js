...
const setEditorElementId = (el, id, marker) => {
...
const formatCode = (el) => {
  const fn = (el2) => {
    const childNodes = Array.from(el2.childNodes);
    if (childNodes.length) {
      childNodes.forEach((childNode) => {
        if (childNode.nodeType == 1) {
          if (childNode.nodeName.toLocaleLowerCase() == "br") {
            let text = document.createTextNode("\n");
            el2.insertBefore(text, childNode);
            childNode.remove();
            ...
            el2.insertBefore(ele, childNode);
            childNode.remove();
          } else {
...
const editor_vue_vue_type_style_index_0_scoped_ab438550_lang = "";
const _sfc_main$7 = {
  name: "m-editor",
  props: {
    modelValue: {
...
const Editor = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$7], ["__scopeId", "data-v-ab438550"]]);
Editor.install = (app) => {
...
const editorMenu_vue_vue_type_style_index_0_scoped_c15cc815_lang = "";
const _sfc_main$5 = {
  name: "m-editor-menu",
  props: {
    options: {
...
const editorMenu = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$5], ["__scopeId", "data-v-c15cc815"]]);
const editorMenus_vue_vue_type_style_index_0_scoped_130060d6_lang = "";
const _sfc_main$4 = {
  name: "m-editor-menus",
  emits: ["custom"],
  props: {
...
const EditorMenus = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$4], ["__scopeId", "data-v-130060d6"]]);
