...
const layer_vue_vue_type_style_index_0_scoped_f1748d15_lang = "";
const _sfc_main$j = {
  name: "m-layer",
  data() {
    return {
...
const Layer = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["render", _sfc_render$j], ["__scopeId", "data-v-f1748d15"]]);
Layer.install = (app) => {
  app.component(Layer.name, Layer);
};
const tooltip_vue_vue_type_style_index_0_scoped_d7589715_lang = "";
const _sfc_main$i = {
  name: "m-tooltip",
  data() {
    return {
...
const Tooltip = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["render", _sfc_render$i], ["__scopeId", "data-v-d7589715"]]);
Tooltip.install = (app) => {
