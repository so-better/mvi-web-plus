...
const checkbox_vue_vue_type_style_index_0_scoped_054cb9fe_lang = "";
const _sfc_main$U = {
  name: "m-checkbox",
...
const Checkbox = /* @__PURE__ */ _export_sfc(_sfc_main$U, [["render", _sfc_render$U], ["__scopeId", "data-v-054cb9fe"]]);
Checkbox.install = (app) => {
  app.component(Checkbox.name, Checkbox);
};
const radio_vue_vue_type_style_index_0_scoped_7c1627e1_lang = "";
const _sfc_main$T = {
  name: "m-radio",
  emits: ["update:modelValue", "change"],
  props: {
...
const Radio = /* @__PURE__ */ _export_sfc(_sfc_main$T, [["render", _sfc_render$T], ["__scopeId", "data-v-7c1627e1"]]);
Radio.install = (app) => {
