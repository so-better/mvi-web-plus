...
const layer_vue_vue_type_style_index_0_scoped_f25988e2_lang = "";
const _sfc_main$j = {
  name: "m-layer",
  data() {
    return {
...
const Layer = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["render", _sfc_render$j], ["__scopeId", "data-v-f25988e2"]]);
Layer.install = (app) => {
