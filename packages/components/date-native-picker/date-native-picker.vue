<script setup name="m-date-native-picker" lang="ts">
...
<template>
    <input ref="elRef" @blur="selectDateForIOS" @change="selectDateForAndroid" class="mvi-date-native-picker"
        :type="dateType" :value="defaultDate" />
</template>
