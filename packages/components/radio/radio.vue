...
<template>
    <label class="mvi-radio" :disabled="disabled || null">
        <span v-if="placement == 'left' && label" class="mvi-radio-label" :data-placement="placement"
            v-text="label"></span>
        ...
        <span v-if="placement == 'right' && label" class="mvi-radio-label" :data-placement="placement"
            v-text="label"></span>
    </label>
</template>
