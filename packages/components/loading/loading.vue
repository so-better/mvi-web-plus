...
<template>
    <div class="mvi-loading">
        ...
        <svg v-else-if="type == 'circle'" xmlns="https://www.w3.org/2000/svg" :width="size" :height="size"
            viewBox="0 0 38 38" :stroke="color">
        ...
        <svg v-else-if="type == 'dots'" xmlns="https://www.w3.org/2000/svg" :width="size" :height="size"
            viewBox="0 0 240 60" :fill="color">
            <circle cx="30" cy="30" r="30">
                <animate attributeName="r" from="30" to="30" begin="0s" dur="0.8s" values="30;18;30" calcMode="linear"
                    repeatCount="indefinite" />
            ...
            <circle cx="120" cy="30" r="18" fill-opacity="0.3">
                <animate attributeName="r" from="18" to="18" begin="0s" dur="0.8s" values="18;30;18" calcMode="linear"
                    repeatCount="indefinite" />
                <animate attributeName="fill-opacity" from="0.5" to="0.5" begin="0s" dur="0.8s6s" values=".5;1;.5"
                    calcMode="linear" repeatCount="indefinite" />
            </circle>
        ...
        <svg v-else-if="type == 'spin'" xmlns="https://www.w3.org/2000/svg" :width="size" :height="size"
            viewBox="0 0 38 38">
            <defs>
        ...
        <svg v-else-if="type == 'transfer'" xmlns="http://www.w3.org/2000/svg" :width="size" :height="size"
            viewBox="0 0 25 30">
