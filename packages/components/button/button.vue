<script name="m-button" setup lang="ts">
...
<template>
    <Button :disabled="disabled || null" class="mvi-button" :class="btnClass">
        ...
        <template v-else-if="loading">
            <Icon :type="parseIcon(loadIcon).type" :color="parseIcon(loadIcon).color" :url="parseIcon(loadIcon).url"
                :spin="parseIcon(loadIcon).spin" :size="parseIcon(loadIcon).size" />
